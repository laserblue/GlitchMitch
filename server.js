...
db.serialize(() => {
  if (!exists) {
    ...
    db.serialize(() => {
      db.run(
        'INSERT INTO Dreams (dream) VALUES ("Review my new hybrid Yield Trials like General Pinkley in "The Dirty Dozen".), ("Use knowledge of genetics to save princess"), ("Use Probability Theory: The Logic of Science to pay off my student loan by winning money at Casino Royale playing baccarat"), ("Fly a large shipment of my highly nutritious and aflatoxin resistant hybrid seeds worth millions of dollars from America to Africa to fund my maize breeding research.")'
      );
    });
  } else {
